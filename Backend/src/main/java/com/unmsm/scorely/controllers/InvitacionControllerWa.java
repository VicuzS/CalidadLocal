...
import com.unmsm.scorely.services.imp.InvitacionServiceWa;
...
public class InvitacionControllerWa {

    private final InvitacionServiceWa invitacionService;

    @Value("${frontend.url}")
    private String frontendUrl;

    public InvitacionControllerWa(InvitacionServiceWa invitacionService) {
